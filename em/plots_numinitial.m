...
%             disp(['iteration ' num2str(iteration) ' rmsE: ' num2str(E)]);
            ...
            % only print the final iterations
            if iteration == it
                  h = figure(1);
            subplot(211);
            imagesc(img);
            ...
            colorbar()
            axis image
                print(h,'-depsc2',[figures_path '/numinit'  num2str(k) '_iter' num2str(iteration) '_img' num2str(imgid) '_''.eps']);
            end
...
%         print(h2,'-depsc2',[figures_path '/errors_' num2str(imgid) '_' num2str(k) 'components.eps']);
        ...
        fname = ['numinit_' num2str(imgid) '_' num2str(k) '_components.mat'];
