    ...
    for imgid = image_ids
        ...
        for iteration = 1:it
            ...
            if saveIt==1
                ...
                if ~isdir(fullfile(eventdirs{imgid},'emfitpolar'))
                    mkdir(eventdirs{imgid},'emfitpolar')
                end
                fullfilename = fullfile(eventdirs{imgid},'emfitpolar',fname);
